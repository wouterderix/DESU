        ...
        <asp:Menu ID="Menu1" runat="server" BorderStyle="None" OnMenuItemClick="Menu1_MenuItemClick">
            <Items>
                <asp:MenuItem Text="Occasions" Value="" Enabled="true">
                    <asp:MenuItem Text="Evenement Overzicht" Value="" Enabled="True" NavigateUrl="~/UI/Occasion_Overzicht.aspx"></asp:MenuItem>
                    <asp:MenuItem Text="Evenement Controlleren" Value="" Enabled="True" NavigateUrl="~/UI/Occasion_Controlleren.aspx"></asp:MenuItem>
                    <asp:MenuItem Text="Evenement Toevoegen" Value="" Enabled="True" NavigateUrl="~/UI/Occasion_Toevoegen.aspx"></asp:MenuItem>
                </asp:MenuItem>
                ...
                <asp:MenuItem Text="Nieuws" Value="" Enabled="true">
                    <asp:MenuItem Text="Nieuws Goedkeuren" Value="" Enabled="True" NavigateUrl="~/UI/ApproveNews.aspx"></asp:MenuItem>
                    <asp:MenuItem Text="Nieuws Inzien" Value="" Enabled="True" NavigateUrl="~/UI/GetNews.aspx"></asp:MenuItem>
                    <asp:MenuItem Text="Nieuws Bewerken" Value="" Enabled="True" NavigateUrl="~/UI/UpdateNews.aspx"></asp:MenuItem>
                </asp:MenuItem>
                <asp:MenuItem Text="Contact" Value="" Enabled="true" NavigateUrl="~/UI/Contact.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Controleer Data" Value="" Enabled="true" NavigateUrl="~/UI/CheckDate.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Log Inzien" Value="" Enabled="true" NavigateUrl="~/UI/AuditLogUI.aspx"></asp:MenuItem>
            </Items>
        </asp:Menu>
    </div>
    </form>
