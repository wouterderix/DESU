...
<body>
    <form id="form1" runat="server">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Review" ErrorMessage="RequiredFieldValidator" ForeColor="Red">Review moet ingevuld zijn</asp:RequiredFieldValidator>        
    </div>    
    ...
    <div style="margin-top:10px">
        <asp:Button ID="Button1" runat="server" Text="Verzenden" OnClick="Button1_Click"  />  
    </div>
    </form>
</body>
</html>
